...
// FIXME: We do not use the pretty printing table atm.
/** 
...
/**
 * Convert a coqdoc comment to markdown.
 * @param commentContent The coqdoc comment to convert.
 * @returns The markdown representation of the coqdoc comment.
 */
export function translateCoqDoc(commentContent: string) {
    let commentInside = commentContent;
