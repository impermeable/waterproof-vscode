...
const ProofAssistant = ({ data }: { data: TacticsData }) => {
  ...
  const handleInsert = (_event: React.MouseEvent, template: string) => {
    ...
    vscode.postMessage({
      ...
      body: { symbolLatex: template, symbolUnicode: template, type: "tactics" },
    });
  };
        ...
        <div className="tactic-header">
          ...
          <div className="button-group">
            ...
            <VSCodeButton
              className="tooltip"
              appearance="primary"
              onClick={(event) => handleCopy(event, name)}
            >
              {"\u2398"}
            ...
            <VSCodeButton
              className="tooltip"
              appearance="primary"
              onClick={(event) => handleInsert(event, template)}
            >
              {"\u270e"}
