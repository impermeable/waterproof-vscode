...
Download and execute the bundled installer `Waterproof-dependencies-wp-3.1.0+9.0-Windows-x86_64.exe` from the [release page](https://github.com/impermeable/waterproof-dependencies-installer/releases/download/v3.1.0%2B9.0/Waterproof-dependencies-wp-3.1.0+9.0-Windows-x86_64.exe)
