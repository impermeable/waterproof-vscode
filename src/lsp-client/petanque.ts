...
export const goalsReq = new RequestType<GoalParams, GoalConfig<string>, void>(
  "petanque/goals",
);
export const runReq = new RequestType<RunParams, RunResult<number>, void>(
  "petanque/run",
);
export const getStateAtPosReq = new RequestType<
  GetStateAtPosParams,
  RunResult<number>,
  void
