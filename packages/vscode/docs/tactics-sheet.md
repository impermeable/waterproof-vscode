...
## `Assume that (*statement*) as ((*label*)).`
...
## `It holds that *statement* as ((*label*)).`
...
## `By ((*lemma or assumption*)) it holds that (*statement*) as ((*label*)).`
...
## `By magic it holds that (*statement*) as ((*label*)).`
