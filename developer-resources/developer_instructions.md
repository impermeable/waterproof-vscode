...
Contributing code with use of AI is allowed, subject to the following conditions:

- You disclose the ways you have used AI.
- You assume responsibility for code included in a pull request as if you wrote it yourself.
- You think about a feature or bug before asking the AI to do anything. 
- Before you make a PR with code generated by AI for somebody else to review, please carefully go over and analyze the code yourself, as if you were doing a review of the PR. If necessary, make the code clearer and add documentation, or remove unnecessary parts.
- If you do not understand something in particular or want a second opinion on a specific trade-off, it is fine to start the PR as a draft, and note the relevant questions in the PR description.

These guidelines are intended to keep the quality level of our codebase up, and make sure that we understand the code included in Waterproof.
