...
// Get the button data
import data from "../../completions/symbols+lean.json";
...
export function Symbols() {
  ...
  const handleInsert = (event, id, title) => {
    ...
    vscode.postMessage({
      ...
      body: { symbolLatex: id, symbolUnicode: title, type: "symbol" },
    });
  };
  ...
  return (
    <div className="info-panel-container">
      ...
      <div>{capitalButtons}</div>
      <VSCodeDivider />
      <div id="view-6">
        <p>Calligraphic Letters</p>
      </div>
      <div>{calligraphicButtons}</div>
      <VSCodeDivider />
      {/* Math symbol buttons */}
      <div id="view-3">
