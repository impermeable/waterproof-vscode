...
export namespace RocqLspServerConfig {
  export function create(client_version: string): RocqLspServerConfig {
    return {
      client_version: client_version,
      eager_diagnostics: WaterproofConfigHelper.get(
        WaterproofSetting.EagerDiagnostics,
      ),
      goal_after_tactic: WaterproofConfigHelper.get(
        WaterproofSetting.GoalAfterTactic,
      ),
      show_coq_info_messages: WaterproofConfigHelper.get(
        WaterproofSetting.ShowWaterproofInfoMessages,
      ),
      show_notices_as_diagnostics: WaterproofConfigHelper.get(
        WaterproofSetting.ShowNoticesAsDiagnostics,
      ),
      admit_on_bad_qed: WaterproofConfigHelper.get(
        WaterproofSetting.AdmitOnBadQed,
      ),
      debug: WaterproofConfigHelper.get(WaterproofSetting.Debug),
      unicode_completion: WaterproofConfigHelper.get(
        WaterproofSetting.UnicodeCompletion,
      ),
      ...
      send_diags_extra_data: WaterproofConfigHelper.get(
        WaterproofSetting.SendDiagsExtraData,
      ),
      check_only_on_request: !WaterproofConfigHelper.get(
