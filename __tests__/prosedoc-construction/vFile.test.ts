...
test("vFile with input area", () => {
  ...
  expect(mapping.root.tagRange).toStrictEqual<BlockRange>({
    from: 0,
    to: doc.length,
  });
  expect(mapping.root.contentRange).toStrictEqual<BlockRange>({
    from: 0,
    to: doc.length,
  });
  ...
  expect(mapping.root.children[0].tagRange).toStrictEqual<BlockRange>({
    from: 0,
    to: 8,
  });
  expect(mapping.root.children[0].contentRange).toStrictEqual<BlockRange>({
    from: 4,
    to: 5,
  });
  ...
  expect(mapping.root.children[1].tagRange).toStrictEqual<BlockRange>({
    from: 8,
    to: 9,
  });
  expect(mapping.root.children[1].contentRange).toStrictEqual<BlockRange>({
    from: 8,
    to: 9,
  });
  ...
  expect(mapping.root.children[2].tagRange).toStrictEqual<BlockRange>({
    from: 9,
    to: 10,
  });
  expect(mapping.root.children[2].contentRange).toStrictEqual<BlockRange>({
    from: 9,
    to: 10,
  });
  ...
  expect(mapping.root.children[3].tagRange).toStrictEqual<BlockRange>({
    from: 10,
    to: 11,
  });
  expect(mapping.root.children[3].contentRange).toStrictEqual<BlockRange>({
    from: 10,
    to: 11,
  });
  ...
  expect(mapping.root.children[4].tagRange).toStrictEqual<BlockRange>({
    from: 11,
    to: 46,
  });
  expect(mapping.root.children[4].contentRange).toStrictEqual<BlockRange>({
    from: 29,
    to: 30,
  });
  ...
  expect(
    mapping.root.children[4].children[0].tagRange,
  ).toStrictEqual<BlockRange>({ from: 29, to: 30 });
  expect(
    mapping.root.children[4].children[0].contentRange,
  ).toStrictEqual<BlockRange>({ from: 29, to: 30 });
  ...
  expect(mapping.root.children[5].tagRange).toStrictEqual<BlockRange>({
    from: 46,
    to: 47,
  });
  expect(mapping.root.children[5].contentRange).toStrictEqual<BlockRange>({
    from: 46,
    to: 47,
  });
  ...
  expect(mapping.root.children[6].tagRange).toStrictEqual<BlockRange>({
    from: 47,
    to: doc.length,
  });
  expect(mapping.root.children[6].contentRange).toStrictEqual<BlockRange>({
    from: 51,
    to: 52,
  });
