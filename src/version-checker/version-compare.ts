...
export const versionGreaterThan = (
  required: Version,
  installed: Version,
): boolean => {
...
export const versionEquals = (
  required: Version,
  installed: Version,
): boolean => {
  if (required.patch === NOT_SPECIFIED)
    return versionEqualsIgnorePatch(required, installed);
  return (
...
export const versionEqualsIgnorePatch = (
  required: Version,
  installed: Version,
): boolean => {
