...
export type Message = 
    ...
    | MessageBase<MessageType.renderGoals, { goals: GoalAnswer<PpString> | GoalAnswer<PpString>[] | undefined }>
    ...
    | MessageBase<MessageType.setData, { data: string[] | GoalAnswer<PpString> }>
    | MessageBase<MessageType.teacher, boolean>
    | MessageBase<MessageType.setAutocomplete, { completions: Completion[] }>
    ...
    | MessageBase<MessageType.setShowLineNumbers, { showLineNumbers: boolean }>;
