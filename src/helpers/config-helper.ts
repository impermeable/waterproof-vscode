...
export class WaterproofConfigHelper {
   ...
   */
  static get<T extends WaterproofSetting>(
    setting: T,
  ): WaterproofSettingTypes[T] {
    return config().get<WaterproofSettingTypes[T]>(
      WaterproofSettingMap[setting],
    ) as WaterproofSettingTypes[T];
  }
   ...
   */
  static async update<T extends WaterproofSetting>(
    setting: T,
    value: WaterproofSettingTypes[T],
