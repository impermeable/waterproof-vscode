 ...
 */
export const rocqGoalRequestType = new RequestType<
  RocqGoalRequest,
 ...
 */
export const rocqFileProgressNotificationType =
  new NotificationType<FileProgressParams>("$/coq/fileProgress");
...
export const executionInformationNotificationType =
  new NotificationType<ExecutionInformationParams>(
 ...
 */
export const rocqServerStatusNotificationType =
  new NotificationType<RocqServerStatus>("$/coq/serverStatus");
