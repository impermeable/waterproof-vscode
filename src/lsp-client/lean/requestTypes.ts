 ...
 */
export const leanGoalRequestType = new RequestType<
  LeanGoalRequest,
  LeanGoalAnswer | null,
  void
>("$/lean/plainGoal");
 ...
 */
export const leanFileProgressNotificationType =
  new NotificationType<FileProgressParams>("$/lean/fileProgress");
